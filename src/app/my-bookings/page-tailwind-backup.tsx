      ...
      <>
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-hotel-large font-hotel-medium tracking-hotel-relaxed">Loading your bookings...</p>
          </div>
        </div>
        <FooterOne />
      </>
      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-8 text-center">
            <h1 className="text-hotel-hero font-hotel-bold tracking-hotel-wide mb-4">
              My Bookings
            </h1>
            <p className="text-hotel-large font-hotel-normal text-gray-600 max-w-2xl mx-auto leading-hotel-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <Card className="text-center p-4">
              <div className="text-hotel-massive font-hotel-heavy text-blue-600">{bookings.length}</div>
              <div className="text-hotel-tiny font-hotel-medium text-gray-600 tracking-hotel-wide">Total Bookings</div>
            </Card>
            <Card className="text-center p-4">
              <div className="text-hotel-massive font-hotel-heavy text-green-600">
                {bookings.filter(b => b.status === 'confirmed').length}
              </div>
              <div className="text-hotel-tiny font-hotel-medium text-gray-600 tracking-hotel-wide">Confirmed</div>
            </Card>
            <Card className="text-center p-4">
              <div className="text-hotel-massive font-hotel-heavy text-yellow-600">
                {bookings.filter(b => b.status === 'pending').length}
              </div>
              <div className="text-hotel-tiny font-hotel-medium text-gray-600 tracking-hotel-wide">Pending</div>
            </Card>
            <Card className="text-center p-4">
              <div className="text-hotel-massive font-hotel-heavy text-red-600">
                {bookings.filter(b => b.status === 'cancelled').length}
              </div>
              <div className="text-hotel-tiny font-hotel-medium text-gray-600 tracking-hotel-wide">Cancelled</div>
            </Card>
          </div>
          ...
          <div className="mb-8 flex flex-wrap justify-center gap-3">
            {(['all', 'confirmed', 'pending', 'cancelled'] as const).map((status) => (
              <Button
                ...
                className="text-hotel-tiny font-hotel-strong capitalize tracking-hotel-relaxed"
              >
                <Filter className="mr-2 h-4 w-4" />
                {status === 'all' ? 'All Bookings' : status}
                <span className="ml-2 bg-white text-hotel-primary rounded-full px-2 py-1 text-hotel-caption font-hotel-semibold">
                  {status === 'all' 
                    ? bookings.length 
          ...
          {filteredBookings.length === 0 ? (
            <Card className="p-12 text-center">
              ...
              <h3 className="text-hotel-huge font-hotel-bold mb-4 tracking-hotel-relaxed">No bookings found</h3>
              <p className="text-hotel-medium font-hotel-normal text-gray-600 mb-6 max-w-md mx-auto leading-hotel-relaxed">
                {filter === 'all' 
          ...
          <div className="mt-16 text-center">
            <h2 className="text-hotel-3xl font-hotel-bold mb-6 tracking-hotel-wide">Quick Actions</h2>
            <div className="flex flex-wrap justify-center gap-4">
              <Button 
                ...
                className="text-hotel-medium font-hotel-semibold tracking-hotel-relaxed"
              >
                <Plus className="mr-2 h-5 w-5" />
                Book Another Room
              </Button>
              <Button 
                ...
                className="text-hotel-medium font-hotel-medium tracking-hotel-relaxed"
              >
                Contact Support
              </Button>
              <Button 
