                ...
                <div className="row">
                    <div className="section__wrapper mb-40 wow fadeInUp">
                        <div className="section__content__left">
                            ...
                            <h2 className="content__title h2 lh-1 text-hotel-3xl font-hotel-bold tracking-hotel-normal">Our Rooms</h2>
                        </div>
                        <div className="section__content__right">
                            <p className="text-hotel-base font-hotel-normal leading-hotel-relaxed">
